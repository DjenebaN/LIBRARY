...
ALTER TABLE PRET
ADD COLUMN Etat INT DEFAULT 4,
ADD CONSTRAINT FK_EtatPret FOREIGN KEY (Etat) REFERENCES ETAT(Id_Etat);

ALTER TABLE PRET 
ADD COLUMN Frais DECIMAL(5,2) DEFAULT 0;
